  ...
  return `
    <div class="mobile-app-shell">
      <header class="mobile-app-header" ${isCommunity ? 'data-community-mobile-header' : ''}>
        ...
        <h1 class="mobile-app-title">${isCommunity ? 'Community' : isMusic ? 'Streaming' : isProducts ? 'Products' : isInbox ? 'Inbox' : isProfile ? 'Profile' : isCamera ? 'Camera' : 'Melogic'}</h1>
      ...
      <nav class="mobile-bottom-nav" aria-label="Mobile primary navigation">
        ...
        <a class="mobile-camera-nav" href="/camera.html" ${isCamera ? 'aria-current="page"' : ''} aria-label="Open Camera"><span class="mobile-camera-glyph" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 7.5h3l1.4-2h7.2l1.4 2h3v11H4v-11Z"/><circle cx="12" cy="13" r="3.4"/></svg></span><span>Camera</span></a>
    ...
    <header class="nav-shell">
      <div class="nav-inner">
        <a class="brand" href="${ROUTES.home}" aria-label="Melogic Records home" data-guide-id="global-nav-brand" data-guide-label="Melogic Records home" data-guide-role="global-nav-link">
          <span class="brand-logo-shell" aria-hidden="true"><img alt="Melogic logo mark" class="brand-logo" data-brand-logo data-loaded="true" src="${brandLogoUrl}" loading="eager" decoding="async" width="38" height="38" /></span><span class="brand-text">MELOGIC RECORDS</span>
        </a>
        ...
        <div class="nav-actions" aria-label="Account and cart actions">
          <a class="button button-muted nav-inbox ${isInbox ? 'is-active' : ''}" data-nav-inbox href="${ROUTES.inbox}" aria-label="Open inbox" data-guide-id="global-nav-inbox" data-guide-label="Inbox" data-guide-role="global-nav-button" ${isInbox ? 'aria-current="page"' : ''}><span class="inbox-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><path d="M4 5.5h16A1.5 1.5 0 0 1 21.5 7v10A1.5 1.5 0 0 1 20 18.5H4A1.5 1.5 0 0 1 2.5 17V7A1.5 1.5 0 0 1 4 5.5Zm0 1a.5.5 0 0 0-.5.5v.42l8.5 5.1 8.5-5.1V7a.5.5 0 0 0-.5-.5H4Zm16.5 2.08-6.94 4.16a2.98 2.98 0 0 1-3.12 0L3.5 8.58V17c0 .28.22.5.5.5h16a.5.5 0 0 0 .5-.5V8.58Z" /></svg></span><span class="inbox-label">Inbox</span><span class="inbox-badge" data-nav-inbox-badge aria-label="No unread inbox items"></span></a>

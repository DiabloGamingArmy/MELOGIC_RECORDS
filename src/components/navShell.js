...
// melogic-community-canonical-plus-action-v2c\nexport function navShell(options = {}) {
  ...
  return `
    <div class="mobile-app-shell">
      <header class="mobile-app-header ${isCommunitySection ? 'community-app-header' : ''} ${isCommunitySearch ? 'community-subview-header' : ''}" ${isCommunity ? 'data-community-mobile-header' : ''}>

...
export function normalizeMarketplacePricingSettings(raw = {}) {
  ...
  return {
    ...
    defaultPlatformFeeBps: asPositiveInteger(raw.defaultPlatformFeeBps, fallback.defaultPlatformFeeBps),
    proPlatformFeeBps: asPositiveInteger(raw.proPlatformFeeBps, fallback.proPlatformFeeBps),
    platformFeeBps: asPositiveInteger(raw.defaultPlatformFeeBps ?? raw.platformFeeBps, fallback.platformFeeBps),

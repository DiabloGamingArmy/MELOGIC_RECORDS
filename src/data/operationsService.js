...
function normalizePricingSettings(raw = {}) {
  ...
  return {
    ...
    defaultPlatformFeeBps: safeBps(raw.defaultPlatformFeeBps, 0, 5000),
    proPlatformFeeBps: safeBps(raw.proPlatformFeeBps, 0, 5000),
    platformFeeBps: safeBps(raw.defaultPlatformFeeBps ?? raw.platformFeeBps, 0, 5000),

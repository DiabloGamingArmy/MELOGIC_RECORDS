export const ROUTES = {
  ...
  billingPayouts: '/account/billing-payouts',
  ...
  inboxContentGifts: '/inbox/content/gifts',
  inboxContentCollaborations: '/inbox/content/collaborations',
  ...
  terms: '/support/terms',
  refundPolicy: '/support/refund-policy',
...
const LEGACY_ROUTE_MAP = {
  ...
  '/billing-payouts.html': ROUTES.billingPayouts,
  ...
  '/terms': ROUTES.terms,
  '/refund-policy.html': ROUTES.refundPolicy,
  '/refund-policy': ROUTES.refundPolicy,
  '/creator-guidelines.html': ROUTES.creatorGuidelines,
  '/creator-guidelines': ROUTES.creatorGuidelines,
  '/ad-policy.html': ROUTES.adPolicy,

...
function openDetachedRegionEditorV7() {
  const regionId = selectedMidiRegionId || midiRollState?.regionId || ''
  const url = new URL(window.location.href)
  url.searchParams.set('souraDetachedPanel', 'midi-roll')
  if (regionId) url.searchParams.set('souraDetachedRegion', regionId)
  else url.searchParams.delete('souraDetachedRegion')

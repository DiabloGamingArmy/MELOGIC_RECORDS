...
void OrigamiHeader::paint(juce::Graphics& g) {
    text(g,"MCT ORIGAMI",{10,8,250,32},25,Palette::text());
    text(g,"MELOGIC CREATIVE TECHNOLOGIES",{11,41,260,16},9,Palette::muted());
    g.setColour(Palette::border());g.drawLine(282,10,298,60,1);g.drawLine(288,10,304,60,1);

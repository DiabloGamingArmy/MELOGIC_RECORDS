...
void OscillatorCard::paintContent(juce::Graphics& g,juce::Rectangle<int> body) {
    text(g,display_.source.toUpperCase(),{87,5,getWidth()-128,25},9,Palette::muted(),juce::Justification::centred);
    ...
    text(g,"INIT  /  "+display_.source.toUpperCase(),caption,8.5f,Palette::muted(),juce::Justification::centred);

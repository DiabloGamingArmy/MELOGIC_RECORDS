...
export const state = {
  ...
  assetBrowserFolder: 'VERTIX/Built-in/Primitives',
  ...
  timelineLoopStartFrame: Number(localStorage.getItem('stageTimelineLoopStartFrame')) || 1,
  timelineLoopEndFrame: Number(localStorage.getItem('stageTimelineLoopEndFrame')) || 250,
  timelinePlayMarkerFrame: null,
  timelinePauseMarkerFrame: null,
...
export function findStageAsset(assetId) {
  return vertixAssetRegistry.getAsset(assetId)
}

...
OscillatorModuleId OrigamiEngine::addOscillatorModule() noexcept { return oscillatorModules_.add(); }
bool OrigamiEngine::removeOscillatorModule(OscillatorModuleId id) noexcept { return oscillatorModules_.remove(id); }
